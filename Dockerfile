...
# COPY ./mysql/driver/mysql-connector-java-8.0.25.jar /opt/atlassian/jira/lib/mysql-connector-java-8.0.25.jar
COPY ./mysql/driver/mysql-connector-java-8.0.32.jar /opt/atlassian/jira/lib/mysql-connector-java-8.0.32.jar
